...
if read -p 'Do you want to edit your configurations? [ Y ]' edit;
...
if read -p 'Time to reboot your machine are you ready? (Make sure the downloads are finished [ Y ]' ready;
then case $ready in Y) echo 'Once you are booted make sure you sre booting with xen and rerun this script for the second part of the setup. Rebooting in 15 seconds...' && sleep 15 && sudo reboot now;;
esac
fi
